  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        const err = error as AxiosError<{ message?: string }>;
        if (active) {
          if (err.response?.status === 401 && shouldIgnoreUnauthorized())
            return;
          ...
          >
            ...
            >
              <path
                ...
                d="M3 16v1a2 2 0 002 2h14a2 2 0 002-2v-1m-4-4l-4 4m0 0l-4-4m4 4V4"
              />
            </svg>
            Unduh Laporan PDF
          </button>
          ...
          <aside className="rounded-4xl border border-slate-200/80 bg-white p-6 shadow-xl shadow-slate-100/40 flex flex-col gap-5 h-full">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                Sesuaikan periode waktu dan kelas.
              </p>
            </div>

            <div className="flex-1 space-y-4">
              <label className="block">
                <span className="mb-2 block text-xs font-medium text-slate-400 uppercase tracking-wider">
                  Bulan
                </span>
                <select
                  value={bulan}
          ...
          <div className="flex flex-col gap-6">
            ...
            <section className="rounded-4xl border border-slate-200/80 bg-white shadow-xl shadow-slate-100/40 overflow-hidden">
              <div className="border-b border-slate-100 px-6 py-4">
                ...
                <p className="text-xs text-slate-400 mt-0.5">
                  Komparasi persebaran status absen siswa.
                </p>
              </div>
            ...
            <section className="flex flex-col rounded-4xl border border-slate-200/80 bg-white shadow-xl shadow-slate-100/40 overflow-hidden flex-1">
              <div className="border-b border-slate-100 px-6 py-4">
                <h3 className="font-semibold text-slate-900 text-sm">
                  Lembar Tabel Rekapitulasi
                </h3>
                <p className="text-xs text-slate-400 mt-0.5">
                  Rincian kuantitas kehadiran kumulatif seluruh siswa.
                </p>
              </div>
                    ...
                    {loading ? (
                      ...
                      paginatedData.map((row, index) => (
                        ...
                        >
                          ...
                          <td className="px-6 py-3.5 text-center text-blue-600 font-semibold">
                            {row.sakit}
                          </td>
                          <td className="px-6 py-3.5 text-center text-amber-600 font-semibold">
                            {row.izin}
                          </td>
                          <td className="px-6 py-3.5 text-center text-red-600 font-semibold">
                            {row.alpha}
                          </td>
                        </tr>
                      ))
